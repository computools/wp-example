...
Insight_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element' => '.page-top-bar-02, .page-top-bar-02 a',
		),
	),
) );
...
Insight_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-top-bar-02 a:hover, .page-top-bar-02 a:focus',
			'property' => 'color',
		),
	),
) );
...
Insight_Kirki::add_field( 'theme', array(
	...
	'output'      => array(
		array(
			'element'  => '.page-top-bar-02 .top-bar-info .info-icon',
			'property' => 'color',
		),
	),
) );
...
Insight_Kirki::add_field( 'theme', array(
	...
	'default'     => array(
		array(
			'text'       => esc_html__( '1 800 977 78 80', 'tm-moody' ),
			'icon_class' => 'fa-phone',
		),
		array(
			'text'       => esc_html__( '3rd Avenue, San Francisco', 'tm-moody' ),
			'icon_class' => 'fa-map-marker',
		),
		array(
			'text'       => esc_html__( 'Mon-Fri: 8am - 7pm', 'tm-moody' ),
