...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<h2><?php esc_html_e( 'Calculate Shipping', 'tm-moody' ); ?></h2>
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<p class="form-row form-row-wide" id="calc_shipping_country_field">
			<select name="calc_shipping_country" id="calc_shipping_country" class="country_to_state country_select"
				...
				<option value=""><?php esc_html_e( 'Select a country&hellip;', 'tm-moody' ); ?></option>
				<?php
			...
			<p class="form-row form-row-wide" id="calc_shipping_state_field">
				...
				if ( is_array( $states ) && empty( $states ) ) {
					...
					?><input type="hidden" name="calc_shipping_state" id="calc_shipping_state"
					         placeholder="<?php esc_attr_e( 'State / county', 'tm-moody' ); ?>" /><?php
					...
					<select name="calc_shipping_state" class="state_select" id="calc_shipping_state"
					        placeholder="<?php esc_attr_e( 'State / county', 'tm-moody' ); ?>">
							<option value=""><?php esc_html_e( 'Select a state&hellip;', 'tm-moody' ); ?></option>
						<?php
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', true ) ) : ?>
			...
			<p class="form-row form-row-wide" id="calc_shipping_city_field">
				<input type="text"
				       ...
				       placeholder="<?php esc_attr_e( 'City', 'tm-moody' ); ?>"
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			...
			<p class="form-row form-row-wide" id="calc_shipping_postcode_field">
				<input type="text"
				       ...
				       placeholder="<?php esc_attr_e( 'Postcode / ZIP', 'tm-moody' ); ?>"
		...
		<p>
			<button type="submit" name="calc_shipping" value="1" class="button">
				<?php esc_html_e( 'Update Totals', 'tm-moody' ); ?>
			</button>
		</p>
