 ...
 */
$title = $source = $image = $custom_src = $onclick = $img_size = $external_img_size = $caption = $img_link_large = $link = $img_link_target = $alignment = $el_class = $css_animation = $style = $external_style = $border_color = $css = '';
...
if ( $full_width ) {
	$css_class .= ' vc_full_width';
}

if ( $tablet_align !== '' ) {
	$css_class .= ' vc_tablet_align_center';
}

if ( $mobile_align !== '' ) {
	$css_class .= ' vc_mobile_align_center';
}
