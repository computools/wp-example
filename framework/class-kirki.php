	...
	class Insight_Kirki {
			...
			foreach ( $fields as $field ) {
				...
				foreach ( $field['output'] as $output ) {
					...
					if ( ! is_array( $value ) ) {
						...
						if ( 'typography' === $field['type'] || 'kirki-typography' === $field['type'] ) {
		...
		public function enqueue_fonts() {
			...
			foreach ( self::$fields as $field ) {
				...
				if ( isset( $field['type'] ) && ( 'typography' == $field['type'] || 'kirki-typography' == $field['type'] ) ) {
